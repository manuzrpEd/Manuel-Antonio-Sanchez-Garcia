...
par0(69,1)=phat_male(69,1);%CJ
par0(70,1)=phat_male(70,1);%wcl
% %tau1
par0(71:81,1)=phat_male(71:81,1);
% %wcl
par0(82,1)=phat_male(82,1);%cons
par0(83,1)=phat_male(83,1);%year_birth
par0(84,1)=phat_male(84,1);%ED2
par0(85,1)=phat_male(85,1);%ED3
%
...
for i=1:length(data_male.year_birth)
    prob_wcl(i,1)=1./(1+exp(par0(82,1)+par0(83,1)*data_male.year_birth(i,1)+par0(84,1)*data_male.ED2(i,1)+par0(85,1)*data_male.ED3(i,1)));
