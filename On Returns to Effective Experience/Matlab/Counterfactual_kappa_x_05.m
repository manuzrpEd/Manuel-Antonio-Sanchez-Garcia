...
optimum(7)=0.5;%dj prob of human k depreciation during JJ
...
wages2=ws_sim;
wages2(wages2==0)=NaN;
ginic_kappa_x_05=ginicoeff(wages2,1);
save('ginic_kappa_x_05.mat','ginic_kappa_x_05')
...
saveas(gcf,'Counterfactual_kappa_x_05.png')
...
hold off
grid on
h=legend('$\bar{\kappa}_x=1/2$','Baseline','Location','Northwest');
legend boxoff
...
ytickformat('%.2f')
set(gca,'FontSize',18)
saveas(gcf,'Counterfactual_kappa_x_05_lcsupply.png')
