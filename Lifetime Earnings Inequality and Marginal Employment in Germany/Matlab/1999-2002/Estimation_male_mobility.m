...
phat_male_mobil=fminsearch(@(x) loglik_mobility(x,par0,data_male.npeople,data_male.year_birth,data_male.year,data_male.ED2,data_male.ED3,data_male.nmobcl,data_male.nwagcl,...
                    data_male.lmexp,data_male.log_ave_wage,data_male.FT,data_male.PT,data_male.MJ,data_male.NE),par_mob,options_fminsearch);
phat_male=par0;
phat_male(1:43,1)=phat_male_mobil(1:43,1);
