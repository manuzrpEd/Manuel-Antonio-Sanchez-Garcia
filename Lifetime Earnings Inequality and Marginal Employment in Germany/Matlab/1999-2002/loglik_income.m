function z=loglik_income(y,x,npeople,year_birth,ED2,ED3,nmobcl,nwagcl,lmexp,log_ave_wage,FT,PT,MJ,NE,UB)
clear mex
observ=NE;
int=NE==1;
int2=UB==0;
...
% end
for kw=1:nwagcl
    a=lincome_19992002_panel(parmu,parsigma,partau1,int32(kw),ED2,ED3,lmexp,log_ave_wage,FT,PT,MJ,NE,int32(npeople)).*(numinccl(parwcl,kw,year_birth,ED2,ED3)./deninccl);%
    b=(1-isnan(FT));
    a(b==0)=1;
    likw_panel(:,:,kw)=a;
end
