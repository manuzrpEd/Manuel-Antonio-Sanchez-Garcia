...
% %mu
par0(44,1)=phat_male(44,1);%cons+2.5
...
% %sigma
par0(52,1)=phat_male(52,1);%cons % I may need to add ED2 ED3 pending
...
% options_pattern = optimoptions('patternsearch','Display','iter','MaxIter',1000,'MaxFunEval',1000);%,'AccelerateMesh',true
...
phat_male_income=fminsearch(@(x) loglik_income(x,par0,data_male.npeople,data_male.year_birth,data_male.ED2,data_male.ED3,data_male.nmobcl,data_male.nwagcl,...
                    data_male.lmexp,data_male.log_ave_wage,data_male.FT,data_male.PT,data_male.MJ,data_male.NE...
                    ,data_male.UB),par_inc,options_fminsearch);
...
phat_male=par0;
phat_male(44:end,1)=phat_male_income(1:end,1);
