...
*gen month_diff_epi=month_endepi-month_begepi+1 if source==5
*expand month_diff_epi if source==5
*sort persnr year source begepi
*I need to re-number their months
*bysort persnr year counter_spell begepi source: replace month_begepi=month_begepi-1+_n if source==5
*bysort persnr year counter_spell begepi source: replace month_endepi=month_begepi if source==5
*drop month_diff_epi
*
...
bysort year: gen count_year=_n
keep if count_year==1
*saveold "/panfs/panasas01/efim/ms15072/Preliminars_monthly_fem.dta", replace
