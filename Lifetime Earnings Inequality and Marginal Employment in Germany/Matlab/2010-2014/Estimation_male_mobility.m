...
close all
clear mex
disp('Estimation Males 2010-2014')
%356153 Good FIT, convergence
...
load('phat_male.mat','phat_male')%this is from the whole sample estimation! only loaded for the first estimation of 2005-2009
% % par0=phat_male;
par0=zeros(1,1);
% % iniPT
...
%
% tic
initial_loglik=loglik_mobility(par_mob,par0,data_male.npeople,data_male.year_birth,data_male.ED2,data_male.ED3,data_male.nmobcl,data_male.nwagcl,...
...
% options_pattern = optimoptions('patternsearch','Display','iter','MaxIter',1e6,'MaxFunEval',10000);
...
% phat_male_mobil=patternsearch(@(x) loglik_mobility(x,par0,data_male.npeople,data_male.year_birth,data_male.year,data_male.ED2,data_male.ED3,data_male.nmobcl,data_male.nwagcl,...
%                     data_male.lmexp,data_male.log_ave_wage,data_male.FT,data_male.PT,data_male.MJ,data_male.NE,data_male.CJ),par_mob,[],[],[],[],[],[],[],options_pattern);
...
phat_male_mobil=fminsearch(@(x) loglik_mobility(x,par0,data_male.npeople,data_male.year_birth,data_male.ED2,data_male.ED3,data_male.nmobcl,data_male.nwagcl,...
                    data_male.lmexp,data_male.log_ave_wage,data_male.FT,data_male.PT,data_male.MJ,data_male.NE,data_male.CJ),par_mob,options_fminsearch);
phat_male=par0;
phat_male(1:60,1)=phat_male_mobil(1:60,1);
