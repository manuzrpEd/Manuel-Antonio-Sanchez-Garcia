...
gen adj_daily_wage=daily_wage/0.4 if part_time==1 & employment_status!=3 & midi_jobs!=1 & midi_jobs!=2 & source==1
replace adj_daily_wage=daily_wage/0.33 if employment_status==3 & source==1
replace adj_daily_wage=daily_wage/0.4 if midi_jobs==2 & source==1
replace adj_daily_wage=daily_wage/0.4 if midi_jobs==1 & source==1
replace adj_daily_wage=daily_wage if part_time==0 & employment_status!=3 & midi_jobs!=1 & midi_jobs!=2 & source==1
