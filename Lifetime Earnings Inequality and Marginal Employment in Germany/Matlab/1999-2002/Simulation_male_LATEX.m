...
['FT: ' num2str(prob_PT(5),'%4.2f') '&' num2str(prob_MJ(5),'%4.2f') '&' num2str(prob_NE(5),'%4.2f') '&' num2str(prob_CJ(5),'%4.2f')]
...
['Constant: ' num2str(mu(1),'%4.2f') '&' num2str(sigma(1),'%4.2f') '&' num2str(acv1(1),'%4.2f') '&' num2str(acr_cons,'%4.2f')]
['High-School: ' num2str(mu(2),'%4.2f') '&' '-' '&' '-' '&' '-']
['College: ' num2str(mu(3),'%4.2f') '&' '-' '&' '-' '&' '-']
['Age: ' num2str(mu(4),'%4.2f') '&' num2str(sigma(2),'%4.2f') '&' num2str(acv1(2),'%4.2f') '&' num2str(acr_cons_exp,'%4.2f')]
...
['k^s=2: ' num2str(mu(1),'%4.2f') '&' num2str(sigma(6),'%4.2f') '&' num2str(acv1(3),'%4.2f') '&' num2str(acr_cons_unobserved,'%4.2f')]
['PT_to_FT: ' '-' '&' '-' '&' num2str(acv1(4),'%4.2f') '&' num2str(acr_cons_PTFT,'%4.2f')]
['MJ_to_FT: ' '-' '&' '-' '&' num2str(acv1(5),'%4.2f') '&' num2str(acr_cons_MJFT,'%4.2f')]
['NE_to_FT: ' '-' '&' '-' '&' num2str(acv1(6),'%4.2f') '&' num2str(acr_cons_NEFT,'%4.2f')]
['CJ_to_FT: ' '-' '&' '-' '&' num2str(acv1(7),'%4.2f') '&' num2str(acr_cons_CJFT,'%4.2f')]
['FT_to_CJ: ' '-' '&' '-' '&' num2str(acv1(8),'%4.2f') '&' num2str(acr_cons_FTCJ,'%4.2f')]
['PT_to_CJ: ' '-' '&' '-' '&' num2str(acv1(9),'%4.2f') '&' num2str(acr_cons_PTCJ,'%4.2f')]
['MJ_to_CJ: ' '-' '&' '-' '&' num2str(acv1(10),'%4.2f') '&' num2str(acr_cons_MJCJ,'%4.2f')]
['NE_to_CJ: ' '-' '&' '-' '&' num2str(acv1(11),'%4.2f') '&' num2str(acr_cons_NECJ,'%4.2f')]
...
fract_mcl=zeros(length(data_male.year_birth),1);
for i=1:length(data_male.year_birth)
    prob_mcl(i,1)=1./(1+exp(par0(56,1)+par0(57,1)*data_male.year_birth(i,1)+par0(58,1)*data_male.ED2(i,1)+par0(59,1)*data_male.ED3(i,1)));
...
disp('Wage Classes')
['k^w: ' num2str(100*fract_wcl_one_samp,'%4.0f') '&' num2str(100*fract_wcl_two_samp,'%4.0f')]
...
ylim([1 6])
print('pred_wage_class_incomeprofiles_males19992002','-dpng')
...
set(y, 'Units', 'Normalized', 'Position', [-0.1, 0.5, 0]);
ylim([0.6 1])
print('pred_wage_class_acvprofiles_males19992002','-dpng')
