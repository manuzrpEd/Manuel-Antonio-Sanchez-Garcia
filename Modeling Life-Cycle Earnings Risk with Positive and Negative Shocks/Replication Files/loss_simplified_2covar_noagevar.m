function error_total=loss_simplified_2covar_noagevar(para,data,H,T,randn_b,rand_shock_s,col,randn_a0)
clear mex
rand('seed',256344);
randn('seed',66573);
rho_n=para(1);
...
sigma_ep0 = linspace(para(7),para(7),T)';
sigma_en0 = linspace(para(8),para(8),T)';
sigma_x0 = linspace(para(9),para(9),T)';
sigma_z0 = linspace(para(10),para(10),T)';
mu_logna=linspace(para(11),para(11),T)';%positive
mu_lognb=linspace(para(12),para(12),T)';%negative
d_three_neg=para(13);%d_three_neg - NEGAtive
d_three_pos=para(14);
sigma_tr0 = linspace(para(15),para(15),T)';
sigma_a=para(16);%to be changed
sigma_epini=para(17);%0.5
sigma_enini=para(18);
mu_epini=para(19);%0.5
mu_enini=para(20);
theta_p=para(21);%0.5
theta_n=para(22);
