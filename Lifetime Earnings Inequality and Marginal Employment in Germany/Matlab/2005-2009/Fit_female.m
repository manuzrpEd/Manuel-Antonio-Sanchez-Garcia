...
cd 'C:\Users\Tony\Desktop\Projects\RSIAB7514\2005-2009'
clc
clear
close all
clear mex
set(0,'DefaultFigureWindowStyle','docked')
disp('Females 2005-2009')
%
...
panel_mob=zeros(length(data_female.log_ave_wage),size(data_female.log_ave_wage,2));
...
for i=1:length(panel_mob)
    prob_PT(i,j)=exp(par0(16,1) + par0(17,1)*exper(i,1) + par0(18,1)*educ2(i,1) + par0(19,1)*educ3(i,1) + par0(20,1)*FT(i,j-1) + par0(21,1)*PT(i,j-1) + par0(22,1)*MJ(i,j-1) + par0(23,1)*NE(i,j-1) + par0(24,1)*CJ(i,j-1))./(den(i,1));
...
for i=1:length(panel_mob)
    prob_MJ(i,j)=exp(par0(26,1) + par0(27,1)*exper(i,1) + par0(28,1)*educ2(i,1) + par0(29,1)*educ3(i,1) + par0(30,1)*FT(i,j-1) + par0(31,1)*PT(i,j-1) + par0(32,1)*MJ(i,j-1) + par0(33,1)*NE(i,j-1) + par0(33,1)*CJ(i,j-1))./(den(i,1));
...
for i=1:length(panel_mob)
    prob_NE(i,j)=exp(par0(36,1) +par0(37,1)*exper(i,1) + par0(38,1)*educ2(i,1) + par0(39,1)*educ3(i,1) +par0(40,1)*FT(i,j-1) + par0(41,1)*PT(i,j-1) + par0(42,1)*MJ(i,j-1) + par0(43,1)*NE(i,j-1) + par0(44,1)*CJ(i,j-1))./(den(i,1));
...
for i=1:length(panel_mob)
    prob_CJ(i,j)=exp(par0(43,1) +par0(47,1)*exper(i,1) + par0(48,1)*educ2(i,1) + par0(49,1)*educ3(i,1) +par0(50,1)*FT(i,j-1) + par0(51,1)*PT(i,j-1) + par0(52,1)*MJ(i,j-1) + par0(53,1)*NE(i,j-1) + par0(54,1)*CJ(i,j-1))./(den(i,1));
...
mu=nan(length(panel_wage),size(panel_wage,2));
sig=nan(length(panel_wage),size(panel_wage,2));
tau1=nan(length(panel_wage),size(panel_wage,2));
...
% 
% %Observed
% obs_FT_wages=data_female.log_ave_wage;
% obs_FT_wages=obs_FT_wages.*(data_female.empstate==1);
% obs_FT_wages=obs_FT_wages(:);
% obs_FT_wages(obs_FT_wages==0)=[];
% obs_PT_wages=data_female.log_ave_wage;
% obs_PT_wages=obs_PT_wages.*(data_female.empstate==2);
% obs_PT_wages=obs_PT_wages(:);
% obs_PT_wages(obs_PT_wages==0)=[];
% obs_MJ_wages=data_female.log_ave_wage;
% obs_MJ_wages=obs_MJ_wages.*(data_female.empstate==3);
% obs_MJ_wages=obs_MJ_wages(:);
% obs_MJ_wages(obs_MJ_wages==0)=[];
% obs_NE_wages=data_female.log_ave_wage;
% obs_NE_wages=obs_NE_wages.*(data_female.empstate==4);
% obs_NE_wages=obs_NE_wages(:);
% obs_NE_wages(obs_NE_wages==0)=[];
% obs_CJ_wages=data_female.log_ave_wage;
% obs_CJ_wages=obs_CJ_wages.*(data_female.empstate==5);
