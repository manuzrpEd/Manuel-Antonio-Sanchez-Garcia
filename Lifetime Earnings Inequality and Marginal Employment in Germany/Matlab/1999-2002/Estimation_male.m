...
options_fminsearch = optimset('Display','iter','MaxFunEvals',5000,'MaxIter',5000,'TolFun',1e-6,'TolX',1e-6);
...
phat_male=fminsearch(@(x) loglik(x,data_male.npeople,data_male.year_birth,data_male.year,data_male.ED2,data_male.ED3,data_male.nmobcl,data_male.nwagcl,...
                    data_male.lmexp,data_male.log_ave_wage,data_male.FT,data_male.PT,data_male.MJ,data_male.NE...
                    ,data_male.lFT,data_male.lPT,data_male.lMJ,data_male.lNE),par0,options_fminsearch);
