...
load('optimum_simplified_2covar_noagevar.mat','optimum_simplified_2covar_noagevar')
col = 31;
H=20000;
T=32;
%196.046
estimates_simplified_2covar_noagevar.rho_n=optimum_simplified_2covar_noagevar(1);
estimates_simplified_2covar_noagevar.rho_p=optimum_simplified_2covar_noagevar(2);
% estimates_simplified_2covar_noagevar.sigma_b = optimum_simplified_2covar_noagevar(3); %c_px - NEGAtive
estimates_simplified_2covar_noagevar.d_one_neg = optimum_simplified_2covar_noagevar(3); %b_px
estimates_simplified_2covar_noagevar.d_two_neg = optimum_simplified_2covar_noagevar(4); %d_one_pos - POSITIVE MARGINAL
estimates_simplified_2covar_noagevar.d_one_pos = optimum_simplified_2covar_noagevar(5); %d_two_pos
estimates_simplified_2covar_noagevar.d_two_pos = optimum_simplified_2covar_noagevar(6);%transitory negative shocks
estimates_simplified_2covar_noagevar.gamma_a_tr_p= optimum_simplified_2covar_noagevar(7); %b_px
% estimates_simplified_2covar_noagevar.gamma_b_tr_p= optimum_simplified_2covar_noagevar(9); %b_px
estimates_simplified_2covar_noagevar.gamma_a_tr_n = optimum_simplified_2covar_noagevar(8); %d_one_pos - POSITIVE MARGINAL
% estimates_simplified_2covar_noagevar.gamma_b_tr_n = optimum_simplified_2covar_noagevar(11); %d_two_pos
estimates_simplified_2covar_noagevar.gamma_a_per_n = optimum_simplified_2covar_noagevar(9);%transitory negative shocks
% estimates_simplified_2covar_noagevar.gamma_b_per_n=optimum_simplified_2covar_noagevar(13);
estimates_simplified_2covar_noagevar.gamma_a_per_p= optimum_simplified_2covar_noagevar(10); %c_px - NEGAtive
% estimates_simplified_2covar_noagevar.gamma_b_per_p=optimum_simplified_2covar_noagevar(15);
estimates_simplified_2covar_noagevar.lambda_a_pos=optimum_simplified_2covar_noagevar(11); %positive
% estimates_simplified_2covar_noagevar.lambda_b_pos=optimum_simplified_2covar_noagevar(17);
estimates_simplified_2covar_noagevar.lambda_a_neg=optimum_simplified_2covar_noagevar(12); %NEGAtive
% estimates_simplified_2covar_noagevar.lambda_b_neg=optimum_simplified_2covar_noagevar(19);
estimates_simplified_2covar_noagevar.d_three_neg=optimum_simplified_2covar_noagevar(13);
estimates_simplified_2covar_noagevar.d_three_pos=optimum_simplified_2covar_noagevar(14);
estimates_simplified_2covar_noagevar.sigma_tra=optimum_simplified_2covar_noagevar(15);
estimates_simplified_2covar_noagevar.sigma_trb=estimates_simplified_2covar_noagevar.sigma_tra;
estimates_simplified_2covar_noagevar.sigma_a=optimum_simplified_2covar_noagevar(16);
estimates_simplified_2covar_noagevar.gamma_epini=optimum_simplified_2covar_noagevar(17);
estimates_simplified_2covar_noagevar.gamma_enini=optimum_simplified_2covar_noagevar(18);
estimates_simplified_2covar_noagevar.mu_epini=optimum_simplified_2covar_noagevar(19);
estimates_simplified_2covar_noagevar.mu_enini=optimum_simplified_2covar_noagevar(20);
estimates_simplified_2covar_noagevar.theta_p=optimum_simplified_2covar_noagevar(21);
estimates_simplified_2covar_noagevar.theta_n=optimum_simplified_2covar_noagevar(22);
save('estimates_simplified_2covar_noagevar.mat','estimates_simplified_2covar_noagevar')
%}
%
rand('seed',256344);
randn('seed',66573);
...
%
rho_n=optimum_simplified_2covar_noagevar(1);
rho_p=optimum_simplified_2covar_noagevar(2);
sigma_b = 0;
d_one_neg = optimum_simplified_2covar_noagevar(3); %c_px - NEGAtive
d_two_neg = optimum_simplified_2covar_noagevar(4); %b_px
d_one_pos = optimum_simplified_2covar_noagevar(5); %d_one_pos - POSITIVE MARGINAL
d_two_pos = optimum_simplified_2covar_noagevar(6); %d_two_pos
gamma_a_tr_p=optimum_simplified_2covar_noagevar(7);%0.5
gamma_b_tr_p=0;
gamma_a_tr_n=optimum_simplified_2covar_noagevar(8);
gamma_b_tr_n=0;
gamma_a_per_n=optimum_simplified_2covar_noagevar(9);
gamma_b_per_n=0;
gamma_a_per_p=optimum_simplified_2covar_noagevar(10);%1.85
gamma_b_per_p=0;
lambda_a_pos=optimum_simplified_2covar_noagevar(11);%posit
lambda_b_pos=0;%posit
lambda_a_neg=optimum_simplified_2covar_noagevar(12);%negativ
lambda_b_neg=0;%negative
d_three_neg=optimum_simplified_2covar_noagevar(13);%d_three_pos - NEGAtive
d_three_pos=optimum_simplified_2covar_noagevar(14);
sigma_tra=optimum_simplified_2covar_noagevar(15);
sigma_trb=sigma_tra;
mu_tra=0;%-0.05
% mu_trb=mu_tra;
sigma_a=optimum_simplified_2covar_noagevar(16);%to be changed
sigma_epini=optimum_simplified_2covar_noagevar(17);%0.5
sigma_enini=optimum_simplified_2covar_noagevar(18);
mu_epini=optimum_simplified_2covar_noagevar(19);%0.5
mu_enini=optimum_simplified_2covar_noagevar(20);
theta_p=optimum_simplified_2covar_noagevar(21);%0.5
theta_n=optimum_simplified_2covar_noagevar(22);
%
...
%
% gamma_b_tr_p=estimates_simplified_2covar_noagevar.gamma_b_tr_p
% gamma_b_tr_n=estimates_simplified_2covar_noagevar.gamma_b_tr_n
% gamma_b_per_n=estimates_simplified_2covar_noagevar.gamma_b_per_n
% gamma_b_per_p=estimates_simplified_2covar_noagevar.gamma_b_per_p
% lambda_b_pos=estimates_simplified_2covar_noagevar.lambda_b_pos
% lambda_b_neg=estimates_simplified_2covar_noagevar.lambda_b_neg
gamma_b_tr=0
lambda_b_tr=0
%variance
...
for i=2:32
    transf_varp_p(i-1)=(exp((estimates_simplified_2covar_noagevar.gamma_a_per_p+gamma_b_per_p*i)^2)-1)*(exp(2*(estimates_simplified_2covar_noagevar.lambda_a_pos+lambda_b_pos*i)+(estimates_simplified_2covar_noagevar.gamma_a_per_p+gamma_b_per_p*i)^2));
end
for i=2:32
    transf_varp_n(i-1)=(exp((estimates_simplified_2covar_noagevar.gamma_a_per_n+gamma_b_per_n*i)^2)-1)*(exp(2*(mu_lognb(i))+(estimates_simplified_2covar_noagevar.gamma_a_per_n+gamma_b_per_n*i)^2));
end
for i=2:32
    transf_vartr_p(i-1)=(exp((estimates_simplified_2covar_noagevar.gamma_a_tr_p+gamma_b_tr_p*i)^2)-1)*(exp(2*(estimates_simplified_2covar_noagevar.lambda_a_pos+lambda_b_pos*i)+(estimates_simplified_2covar_noagevar.gamma_a_tr_p+gamma_b_tr_p*i)^2));
end
for i=2:32
    transf_vartr_n(i-1)=(exp((estimates_simplified_2covar_noagevar.gamma_a_tr_n+gamma_b_tr_n*i)^2)-1)*(exp(2*(mu_lognb(i))+(estimates_simplified_2covar_noagevar.gamma_a_tr_n+gamma_b_tr_n*i)^2));
end
for i=2:32
    transf_vartr(i-1)=(estimates_simplified_2covar_noagevar.sigma_tra+gamma_b_tr*i)^2;
end
%mean
...
for i=2:32
    transf_meanp_p(i-1)=(exp(estimates_simplified_2covar_noagevar.lambda_a_pos+lambda_b_pos*i+((estimates_simplified_2covar_noagevar.gamma_a_per_p+gamma_b_per_p*i)^2)/2));
end
for i=2:32
    transf_meanp_n(i-1)=(exp(mu_lognb(i)+((estimates_simplified_2covar_noagevar.gamma_a_per_n+gamma_b_per_n*i)^2)/2));
end
for i=2:32
    transf_meantr_p(i-1)=(exp(estimates_simplified_2covar_noagevar.lambda_a_pos+lambda_b_pos*i+((estimates_simplified_2covar_noagevar.gamma_a_tr_p+gamma_b_tr_p*i)^2)/2));
end
for i=2:32
    transf_meantr_n(i-1)=(exp(mu_lognb(i)+((estimates_simplified_2covar_noagevar.gamma_a_tr_n+gamma_b_tr_n*i)^2)/2));
end
for i=2:32
...
ylim([-0.4 0.55])
print('pred_2covar_noagevar_mean','-dpng')
%}
figure
...
ylim([0 0.20])
print('pred_2covar_noagevar_var','-dpng')
%
figure
...
ylim([0 0.20])
print('pred_2covar_noagevar_LCV','-dpng')
%
figure
...
ylim([-2 1.5])
print('pred_2covar_noagevar_skew','-dpng')
%
%
figure
...
ylim([-2 1.5])
print('pred_2covar_noagevar_skew_kelly','-dpng')
%
figure
...
ylim([0 1])
print('pred_2covar_noagevar_fractionp','-dpng')
%}
for i=1:31;
...
ylim([0 1])
xlim([25 55])
print('pred_2covar_noagevar_probs','-dpng')
%
%
figure
...
ylim([0 0.1])
xlim([25 55])
print('pred_2covar_noagevar_transfpers','-dpng')
%}
%
figure
...
xt = get(gca, 'XTick');
set(gca, 'FontSize', 24)
ylabel('$Std. Dev. [\iota_{i,h}]$','fontsize',24,'FontWeight','bold','interpreter','latex')
ylim([0 0.4])
xlim([25 55])
print('pred_2covar_noagevar_transftrans','-dpng')
%}
%
figure
...
ylim([-0.3 0.3])
xlim([25 55])
print('pred_2covar_noagevar_transfpers_mean','-dpng')
%}
%
figure
...
xt = get(gca, 'XTick');
set(gca, 'FontSize', 24)
ylabel('$E [\iota_{i,h}]$','fontsize',24,'FontWeight','bold','interpreter','latex')
ylim([-0.4 0.4])
xlim([25 55])
print('pred_2covar_noagevar_transftrans_mean','-dpng')
%}
%
figure
...
ylim([0 20])
print('pred_2covar_noagevar_kurt','-dpng')
%
figure
...
ylim([0 20])
print('pred_2covar_noagevar_kurt_cs','-dpng')
%
%
figure
...
ylim([-0.1 0.02])
print('pred_2covar_noagevar_1stcov','-dpng')
%}
%
figure
...
ylim([-0.015 0.005])
print('pred_2covar_noagevar_2ndcov','-dpng')
%}
%
%Unconditional Mean
figure
...
ylim([-0.04 0.04])
print('pred_2covar_noagevar_uncmean','-dpng')
%}
%
figure
...
ylim([0.2 1])
print('pred_2covar_noagevar_outbound','-dpng')
%}
%
figure
...
print('pred_2covar_noagevar_2UNCACV','-dpng')
%}
%
figure
...
print('pred_2covar_noagevar_3UNCACV','-dpng')
%}
%
figure
...
ylim([0.05 0.3])
print('pred_2covar_noagevar_hump','-dpng')
%
%
figure
...
print('pred_2covar_noagevar_MeanLogEarn','-dpng')
%}
%
%data kernel
...
% ylabel('f(x)','fontsize',24,'FontWeight','bold')
% xlim([-1 1])
% print('pred_2covar_noagevar__logndens_trans','-dpng')
% %
%simulation age of 36
%pers
%UNCONDITIONAL
%
% pred_2covar_noagevar_gr_26=panel_new(:,9);
% pred_2covar_noagevar_gr_26=pred_2covar_noagevar_gr_26(logical(panel_new(:,6)==(27-24)));
% [g,y]=ksdensity(pred_2covar_noagevar_gr_26);
...
% ylim([0 7])
% xlim([-1 1])
% print('pred_2covar_noagevar_kernel26','-dpng')
% %}
% %
% pred_2covar_noagevar_gr_30=panel_new(:,9);
% pred_2covar_noagevar_gr_30=pred_2covar_noagevar_gr_30(logical(panel_new(:,6)==(31-24)));
% [g,y]=ksdensity(pred_2covar_noagevar_gr_30);
...
% ylim([0 7])
% xlim([-1 1])
% print('pred_2covar_noagevar_kernel30','-dpng')
% %}
% %
% pred_2covar_noagevar_gr_36=panel_new(:,9);
% pred_2covar_noagevar_gr_36=pred_2covar_noagevar_gr_36(logical(panel_new(:,6)==(37-24)));
% [g,y]=ksdensity(pred_2covar_noagevar_gr_36);
% [f,x]=ksdensity(data_simplified.gr_36);
% figure
% plot(x,f,'Color', 'blue','LineWidth',2)
% hold on
...
% ylim([0 7])
% xlim([-1 1])
% print('pred_2covar_noagevar_kernel36','-dpng')
% %}
% %
% pred_2covar_noagevar_gr_40=panel_new(:,9);
% pred_2covar_noagevar_gr_40=pred_2covar_noagevar_gr_40(logical(panel_new(:,6)==(41-24)));
% [g,y]=ksdensity(pred_2covar_noagevar_gr_40);
...
% ylim([0 7])
% xlim([-1 1])
% print('pred_2covar_noagevar_kernel40','-dpng')
% %}
% %
% pred_2covar_noagevar_gr_46=panel_new(:,9);
% pred_2covar_noagevar_gr_46=pred_2covar_noagevar_gr_46(logical(panel_new(:,6)==(47-24)));
% [g,y]=ksdensity(pred_2covar_noagevar_gr_46);
...
% ylim([0 7])
% xlim([-1 1])
% print('pred_2covar_noagevar_kernel46','-dpng')
% %}
% %
% pred_2covar_noagevar_gr_50=panel_new(:,9);
% pred_2covar_noagevar_gr_50=pred_2covar_noagevar_gr_50(logical(panel_new(:,6)==(51-24)));
% [g,y]=ksdensity(pred_2covar_noagevar_gr_50);
...
% ylim([0 7])
% xlim([-1 1])
% print('pred_2covar_noagevar_kernel50','-dpng')
% %}
% %
% pred_2covar_noagevar_gr_54=panel_new(:,9);
% pred_2covar_noagevar_gr_54=pred_2covar_noagevar_gr_54(logical(panel_new(:,6)==(55-24)));
% [g,y]=ksdensity(pred_2covar_noagevar_gr_54);
...
% ylim([0 7])
% xlim([-1 1])
% print('pred_2covar_noagevar_kernel54','-dpng')
%}
%purely transitory:
%trans
%
...
fprintf('\n')
optimum_simplified_2covar_noagevar
