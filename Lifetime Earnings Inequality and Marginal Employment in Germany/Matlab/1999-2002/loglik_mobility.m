function z=loglik_mobility(y,x,npeople,year_birth,year,ED2,ED3,nmobcl,nwagcl,lmexp,log_ave_wage,FT,PT,MJ,NE)
clear mex
% DEFINE PARAMETERS
%------------------
...
% end
for km=1:nmobcl
    likm_panel(:,:,km)=lmobil_19992002_panel(pariniPT,parPT,pariniMJ,parMJ,pariniNE,parNE,int32(km),lmexp,ED2,ED3,FT,PT,MJ,NE,int32(npeople)).*(nummobcl(parmcl,km,year_birth,ED2,ED3)./denmobcl);
end
% for km=1:nmobcl
