cd 'C:\Users\manuz\Desktop\RSIAB7514\EarningsDynamics&Institutions\Codes\Matlab\2005-2009'
clc
clear
close all
clear mex
...
for i=1:length(data_female.year_birth)
    prob_mcl_1(i,1)=1./(1+exp(par0(52,1)+par0(53,1)*data_female.year_birth(i,1)+par0(54,1)*data_female.ED2(i,1)++par0(55,1)*data_female.ED3(i,1)));
...
for i=1:length(data_female.year_birth)
    prob_wcl(i,1)=1./(1+exp(par0(99,1)+par0(100,1)*data_female.year_birth(i,1)+par0(101,1)*data_female.ED2(i,1)+par0(102,1)*data_female.ED3(i,1)));
...
fract_mcl=zeros(length(data_female.year_birth),1);
for i=1:length(data_female.year_birth)
    prob_mcl(i,1)=1./(1+exp(par0(52,1)+par0(53,1)*data_female.year_birth(i,1)+par0(54,1)*data_female.ED2(i,1)+par0(55,1)*data_female.ED3(i,1)));
...
ylim([1 6])
print('pred_wage_class_incomeprofiles_females20052009','-dpng')
...
set(y, 'Units', 'Normalized', 'Position', [-0.1, 0.5, 0]);
ylim([0.6 1])
print('pred_wage_class_acvprofiles_females20052009','-dpng')
