...
empstate_20052009_male=model_empstate;
save('empstate_20052009_male.mat','empstate_20052009_male')
wages_20052009_male=wages;
save('wages_20052009_male.mat','wages_20052009_male')
load('data_male.mat','data_male')
x = 2:0.5:12;
...
for i=1:size(data_male.log_ave_wage,1)
    for j=1:size(data_male.log_ave_wage,2)
        if data_male.empstate(i,j)==4 && data_male.UB(i,j)==1
            data_wage_NE(i,j)=data_male.log_ave_wage(i,j);
        end
    end
end
data_wage_CJ=nan(size(data_male.log_ave_wage,1),size(data_male.log_ave_wage,2));
for i=1:size(data_male.log_ave_wage,1)
    for j=1:size(data_male.log_ave_wage,2)
        if data_male.empstate(i,j)==5
            data_wage_CJ(i,j)=data_male.log_ave_wage(i,j);
        end
    end
end
%
...
simul_wage_CJ=nan(size(data_male.log_ave_wage,1),size(data_male.log_ave_wage,2));
for i=1:size(data_male.log_ave_wage,1)
    for j=1:size(data_male.log_ave_wage,2)
        if fract_CJ(i,j)==1
...
hold off
legend('Data','Model')
print('dist_19992002_FT_Male','-dpng')
%PT
A=data_wage_PT;
A=(A(~isnan(A)));
B=simul_wage_PT;
...
hold off
legend('Data','Model')
print('dist_19992002_PT_Male','-dpng')
%MJ
A=data_wage_MJ;
A=(A(~isnan(A)));
B=simul_wage_MJ;
...
hold off
legend('Data','Model')
print('dist_19992002_MJ_Male','-dpng')
%NE
A=data_wage_NE;
A=(A(~isnan(A)));
B=simul_wage_NE;
...
hold off
legend('Data','Model')
print('dist_19992002_NE_Male','-dpng')
...
hold off
legend('Data','Model')
print('dist_19992002_CJ_Male','-dpng')
...
print('ACR_19992002_FT_FT_Male','-dpng')
...
print('ACR_19992002_PT_FT_Male','-dpng')
...
print('ACR_19992002_MJ_FT_Male','-dpng')
...
print('ACR_19992002_NE_FT_Male','-dpng')
...
print('ACR_19992002_CJ_FT_Male','-dpng')
...
print('ACR_19992002_FT_PT_Male','-dpng')
...
print('ACR_19992002_PT_PT_Male','-dpng')
...
set(h(1),'color','r','LineWidth',2)
legend('MJ to PT')
print('ACR_19992002_MJ_PT_Male','-dpng')
...
print('ACR_19992002_NE_PT_Male','-dpng')
...
print('ACR_19992002_CJ_PT_Male','-dpng')
...
set(h(1),'color','r','LineWidth',2)
legend('FT to MJ')
print('ACR_19992002_FT_MJ_Male','-dpng')
...
print('ACR_19992002_PT_MJ_Male','-dpng')
...
set(h(1),'color','r','LineWidth',2)
legend('MJ to MJ')
print('ACR_19992002_MJ_MJ_Male','-dpng')
...
print('ACR_19992002_NE_MJ_Male','-dpng')
...
print('ACR_19992002_CJ_MJ_Male','-dpng')
...
print('ACR_19992002_FT_NE_Male','-dpng')
...
print('ACR_19992002_PT_NE_Male','-dpng')
...
print('ACR_19992002_MJ_NE_Male','-dpng')
...
print('ACR_19992002_NE_NE_Male','-dpng')
...
print('ACR_19992002_CJ_NE_Male','-dpng')
...
print('ACR_19992002_FT_CJ_Male','-dpng')
...
print('ACR_19992002_PT_CJ_Male','-dpng')
...
print('ACR_19992002_MJ_CJ_Male','-dpng')
...
print('ACR_19992002_NE_CJ_Male','-dpng')
...
print('ACR_19992002_CJ_CJ_Male','-dpng')
