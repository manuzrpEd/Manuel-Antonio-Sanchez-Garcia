...
qui drop if def_daily_wage<5.5 & def_daily_wage!=. & form==1
*break after 1999
...
/*
qui drop if def_daily_wage<15 & def_daily_wage!=. & form==1
...
g tc=1 if log_ave_wage>=9.5 & conc_month==1
local T=9.5
...
g tc=1 if log_ave_wage>=9.5 & full_month==1
local T=9.5
...
g tc=1 if log_ave_wage>=9 & part_month==1
local T=9
...
g info=1 if empstate==1 | empstate==2 | empstate==3 | unemp_ben==1
