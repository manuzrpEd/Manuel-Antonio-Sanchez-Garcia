...
saveold "\bonke_`i'_cs_unc_full_r`j'.dta", replace
...
saveold "\bonke_`i'_cs_unc_part_r`j'.dta", replace
...
saveold "\bonke_`i'_cs_unc_mini_r`j'.dta", replace
...
saveold "\bonke_`i'_cs_male_full_r`j'.dta", replace
...
saveold "\bonke_`i'_cs_male_part_r`j'.dta", replace
...
saveold "\bonke_`i'_cs_male_mini_r`j'.dta", replace
...
saveold "\bonke_`i'_cs_female_full_r`j'.dta", replace
...
saveold "\bonke_`i'_cs_female_part_r`j'.dta", replace
...
saveold "\bonke_`i'_cs_female_mini_r`j'.dta", replace
...
saveold "\bonke_`i'_cs_unc_full_shares_r`j'.dta", replace
...
saveold "\bonke_`i'_cs_unc_part_shares_r`j'.dta", replace
...
saveold "\bonke_`i'_cs_unc_mini_shares_r`j'.dta", replace
...
saveold "\bonke_`i'_cs_male_full_shares_r`j'.dta", replace
...
saveold "\bonke_`i'_cs_male_part_shares_r`j'.dta", replace
...
saveold "\bonke_`i'_cs_male_mini_shares_r`j'.dta", replace
...
saveold "\bonke_`i'_cs_female_full_shares_r`j'.dta", replace
...
saveold "\bonke_`i'_cs_female_part_shares_r`j'.dta", replace
...
saveold "\bonke_`i'_cs_female_mini_shares_r`j'.dta", replace
