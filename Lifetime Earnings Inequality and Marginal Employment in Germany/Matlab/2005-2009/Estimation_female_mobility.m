...
load('phat_female.mat','phat_female')%this is from the whole sample estimation! only loaded for the first estimation of 2005-2009
% % par0=phat_female;
par0=zeros(1,1);
% % iniPT
...
%
% tic
initial_loglik=loglik_mobility(par_mob,par0,data_female.npeople,data_female.year_birth,data_female.ED2,data_female.ED3,data_female.nmobcl,data_female.nwagcl,...
...
options_fminsearch = optimset('Display','iter','MaxFunEvals',200000,'MaxIter',200000,'TolFun',1e-6,'TolX',1e-6);
...
phat_female_mobil=fminsearch(@(x) loglik_mobility(x,par0,data_female.npeople,data_female.year_birth,data_female.ED2,data_female.ED3,data_female.nmobcl,data_female.nwagcl,...
                    data_female.lmexp,data_female.log_ave_wage,data_female.FT,data_female.PT,data_female.MJ,data_female.NE,data_female.CJ),par_mob,options_fminsearch);
phat_female=par0;
phat_female(1:60,1)=phat_female_mobil(1:60,1);
