...
% optimum(15)=0.005;
% optimum(16)=-0.0001;
optimum(16)=1;%dj prob of human k depreciation during JJ
optimum(17)=0;%dj prob of human k depreciation during JJ
optimum(18)=0;%dj prob of human k depreciation during JJ
...
wages2=ws_sim;
wages2(wages2==0)=NaN;
ginic_f_1=ginicoeff(wages2,1);
save('ginic_f_1.mat','ginic_f_1')
...
saveas(gcf,'Counterfactual_f_1.png')
...
hold off
grid on
h=legend('$\bar{f}=1$','Baseline','Location','Northwest');
legend boxoff
...
ytickformat('%.2f')
set(gca,'FontSize',18)
saveas(gcf,'Counterfactual_f_1_lcsupply.png')
